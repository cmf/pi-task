...
full specification; there is no separate plan subtask.
...
- If end-to-end behavior needs manual verification, add or update the root
  `## Manual Test Plan` with concrete steps and expected results.
